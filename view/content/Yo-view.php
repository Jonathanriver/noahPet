...
<div class="container yo " ondragstart="return false" onselectstart="return false" oncontextmenu="return false">
    ...
    <div class="row">
        ...
        <div class="col-sm">
            <div class="container">
                <h3 class="order-title">Siempre es bueno conocer propietarios amorosos y responsables</h3>
                <?php
            ...
            <form action="" method="post" class="forms-yo">
                ...
                <div style="padding: 0% 2% 0px 2%;">
                    <div class="row">
                        <div class="col form-yo">
                            <span style="text-align: left;">Mi nombre es
