                ...
                <form action="" method="post" class="forms-condiction">
                    ...
                    <div class="row text-center" style="align-items: center; align-content: center; text-align: center;">
                        ...
                        <?php if ($_SESSION['mi_pet'][$_SESSION['id']]['Pet_Type'] != 'Gato') { ?>
                            <div class="col-sm">
                                <div class="row">
                                    <div id="ideal_og" class="col-sm" <?php echo $physical_build == 'Ideal' ? 'style="display:block;"' : 'style="display:none;"' ?>>
                                        <img class="img-contextura" src="../view/assets/img/delgado_orange.png" alt="" srcset="">
                                    </div>
                                    <div id="ideal_wt" class="col-sm" <?php echo $physical_build == 'Ideal' ? 'style="display:none;"' : 'style="display:block;"' ?>>
                        ...
                        <div class="col-sm">
                            <div class="row">
                                <div id="peso_wt" class="col-sm" <?php echo $physical_build == 'Sobrepeso' ? 'style="display:none;"' : 'style="display:block;"' ?>>
                                    <img class="img-contextura" src="../view/assets/img/sobrepeso_white.png" alt="" style="cursor:pointer;">
                                </div>
                                <div id="peso_og" class="col-sm" <?php echo $physical_build == 'Sobrepeso' ? 'style="display:block;"' : 'style="display:none;"' ?>>
