        ...
        <div class="col-sm">
            <div>
                <form action="" method="post" class="forms-condiction">
                    <h2><span class="color-test-h2">'<?php echo ucfirst($_SESSION['mi_pet'][$_SESSION['id']]['Name_Pet']); ?>'</span> tiene una condición m&eacute;dica adicional?</h2>
                    <?php
                    if (isset($sessionSmg)) {
                        if ($sessionSmg != '') { ?>
                    ...
                    <p class="text-20">Escriba la condición m&eacute;dica adicional de ser necesario.</span></p>
                    <br>
                    <div class="row">
                        <div class="col-sm">
