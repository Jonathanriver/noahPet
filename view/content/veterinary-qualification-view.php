    ...
    <div class="row">
        ...
        <div class="col-sm">
            <form action="#" method="POST" class="forms-condiction" enctype="multipart/form-data">
                ...
                <h2>Cómo califica la condición m&eacute;dica de <span class="color-test-h2">'<?php echo ucfirst($_SESSION['mi_pet'][$_SESSION['id']]['Name_Pet']); ?>'</span> segun su veterinario?</h2>
                <?php
                if (isset($sessionSmg)) {
                    if ($sessionSmg != '') {
                ?>
                ...
                ?>
                <p class="text-20">Por favor seleccione una condición m&eacute;dica para su mascota.</span></p>
                <br>
                <br>
                <!-- Primera session -->
                <div class="row">
