        ...
        <div class="col-sm">
            <div>
                <form action="" method="post" class="forms-condiction">
                    ...
                    <p class="text-20">Por favor seleccione el nivel de actividad fisica de su mascota.</p>
                    <div class="row text-center">
                        <div class="col-sm">
                            <div class="row">
                                <div id="poc_At_og" class="col-sm" <?php echo $physical_activity == 'Poco Activo' ? 'style="display:block;"' : 'style="display:none;"' ?>>
                                    <img class="img-contextura" src="../view/assets/img/poco_activo_og.png" alt="" srcset="">
                                </div>
                                <div id="poc_At_wt" class="col-sm" <?php echo $physical_activity == 'Poco Activo' ? 'style="display:none;"' : 'style="display:block;"' ?>>
                        ...
                        <div class="col-sm">
                            <div class="row">
                                <div id="activa_og" class="col-sm" <?php echo $physical_activity == 'Activa' ? 'style="display:block;"' : 'style="display:none;"' ?>>
                                    <img class="img-contextura" src="../view/assets/img/activa_og.png" alt="" srcset="">
                                </div>
                                <div id="activa_wt" class="col-sm" <?php echo $physical_activity == 'Activa' ? 'style="display:none;"' : 'style="display:block;"' ?>>
                        ...
                        <div class="col-sm">
                            <div class="row">
                                <div id="m_activa_wt" class="col-sm" <?php echo $physical_activity == 'Muy activo' ? 'style="display:none;"' : 'style="display:block;"' ?>>
                                    <img class="img-contextura" src="../view/assets/img/muy_activa_wt.png" alt="" srcset="">
                                </div>
                                <div id="m_activa_og" class="col-sm" <?php echo $physical_activity == 'Muy activo' ? 'style="display:block;"' : 'style="display:none;"' ?>>
